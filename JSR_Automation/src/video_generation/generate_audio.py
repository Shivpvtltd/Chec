...
# ============================================================================
# XTTS v2 AUDIO GENERATION (CI-SAFE)
# ============================================================================
...
class XTTSAudioGenerator:
    ...
    def load_model(self):
        ...
        try:
            ...
            # XTTS v2 loaded successfully - model ready for speaker_idx
            log("ℹ️ XTTS v2 multi-speaker model ready (using speaker_idx=0)")
    ...
    def _generate_with_heartbeat(self, text: str, chunk_id: int) -> Optional[np.ndarray]:
        ...
        try:
            ...
            for i, segment in enumerate(segments):
                ...
                # XTTS v2 inference with speaker_idx (production-safe)
                wav = self.tts.tts(text=segment, language=self.language, speaker_idx=0)
